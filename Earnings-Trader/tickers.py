# Static ticker list: S&P 500 + high-volume options tickers
...
SP500 = [
    ...
    "GD","GIS","GM","GPC","GILD","GS","HAL","HIG","HAS","HCA","DOC","HSIC",
    ...
    "LII","LLY","LIN","LYV","LKQ","LMT","L","LOW","LULU","LYB","MTB","MRO",
    ...
    "NFLX","NWL","NEM","NWSA","NWS","NEE","NKE","NI","NDSN","NSC","NTRS","NOC",
    "NCLH","NRG","NUE","NVR","NVDA","NVO","NVT","NXPI","ORLY","OXY","ODFL",
    "OMC","ON","OKE","ORCL","OTIS","PCAR","PKG","PLTR","PH","PAYX","PAYC","PYPL",
    ...
    "WELL","WST","WDC","WRK","WY","WHR","WMB","WTW","WYNN","XEL","XYZ","XYLM",
    "YUM","ZBRA","ZBH","ZTS",
]

SUPPLEMENTAL = [
    "HOOD","COIN","MSTR","RBLX","SNAP","UBER","LYFT","DASH","ZM","DOCU","ROKU",
    "GME","AMC","MARA","RIOT","SPCE","TLRY","DKNG","PENN","CHPT","NKLA","PLUG",
    "FCEL","BE","CLNE","RUN","NOVA","ENPH","SEDG","FSLR","BLNK","EVGO","ARM",
    "CRWD","SNOW","SHOP","SOFI","RIVN","LCID","AVGO","TSM","ASML","PANW","NOW",
